# Operator Quickstart — Sports and recreation education

Shortest path from clone to a verified local dry-run for **ISIC 8541** (`cloud-itonami-isic-8541`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-8541.git
cd cloud-itonami-isic-8541
```
...
- Blueprint governor key: `instruction-safety-governor`
- Likely source path: `sports.governor.cljc`
